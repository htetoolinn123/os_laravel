...
<head>
    ...
    <!-- CUSTOM CSS -->
    <link rel="stylesheet" type="text/css" href="{{ asset('front/frontend/css/font.css')}}">
    <link rel="stylesheet" type="text/css" href="{{ asset('front/frontend/css/style.css')}}">
    <link rel="stylesheet" type="text/css" href="{{ asset('front/frantend/css/media_query.css')}}">
    
    <!-- BOOTSTRAP CSS -->
    <link rel="stylesheet" type="text/css" href="{{ asset('front/frontend/css/bootstrap.min.css')}}">

    <!-- OWL CAROUSEL -->
    <link rel="stylesheet" type="text/css" href="{{ asset('front/frontend/css/owl.carousel.css')}}">
    <link rel="stylesheet" type="text/css" href="{{ asset('front/frontend/css/owl.theme.default.css')}}">

    <link rel="stylesheet" type="text/css" href="{{ asset('front/fontawesome-free/css/all.min.css')}}">
...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row shadow-sm p-3 bg-white rounded d-flex align-items-center">
			...
			<div class="col-xl-2 col-lg-2 col-md-4 col-sm-4 col-4 order-1">
				...
				<img src="front/logo/logo_big.jpg" class="img-fluid d-xl-inline d-lg-inline d-md-none d-sm-none d-none">

				<img src="front/logo/logo_med.jpg" class="img-fluid d-xl-none d-lg-none d-md-inline d-sm-none d-none" style="width: 100px">

				<img src="frontlogo/logo.jpg" class="img-fluid d-xl-none d-lg-none d-md-none d-sm-inline d-inline pl-2" style="width: 30px">
				</a>
			</div>
			...
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6 order-xl-3 order-lg-3 order-md-4 order-sm-4 order-4 text-right">
				...
				<a href="{{route('shoppingcartpage')}}" class="text-decoration-none d-xl-inline d-lg-inline d-md-inline d-sm-none d-none shoppingcartLink"> 
					...
					<span class="badge badge-pill badge-light badge-notify cartNotistyle cartNoti cartnoti"></span>
						<span class=" total">
						</span> Ks
				</a>
				...
				<img src="front/frontend/image/download.png" class="img-fluid d-xl-inline d-lg-inline d-md-none d-sm-none d-none" style="width: 150px">
			</div>
		</div>
	</div>
	<div id="myPage"></div>
			          	...
			          	<li class="dropdown-submenu">
				            ...
				            <ul class="dropdown-menu">
				            	...
				            	<h6 class="dropdown-header">
				            		<a href="{{route('subcategory',$subcategory->id)}}" class="text-decoration-none text-dark">
	...
	<div id="mySidebar" class="sidebar">
		...
		<div class="mt-3">
			...
			<img src="front/frontend/image/download.png" class="img-fluid ml-2 text-center" style="width: 150px">
			<hr>
  	...
  	<footer class="py-3 mt-5">
    	<div class="container">
    		<div class="text-center pb-3">
      		...
      		<p class="m-0 text-center text-white">Copyright &copy; <img src="front/logo/logo_wh_transparent.png" style="width: 30px; height: 30px"> 2019</p>
    	</div>
  	</footer>

	<script type="text/javascript" src="{{ asset('front/frontend/js/jquery.min.js')}}"></script>
	<!-- BOOTSTRAP JS -->
    <script type="text/javascript" src="{{ asset('front/frontend/js/bootstrap.bundle.min.js')}}"></script>
	<script src="https://cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.6.0/slick.js"></script>
    <script type="text/javascript" src="{{ asset('front/frontend/js/custom.js')}}"></script>
    <script type="text/javascript" src="{{ asset('front/frontend/js/localstroage_custom.js')}}"></script>
    <!-- Owl Carousel -->
    <script type="text/javascript" src="{{asset('front/frontend/js/owl.carousel.js')}}"></script>
